...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section background="#191E22" padding="64px 0" sm-padding="40px 0">
			<Stack>
				<StackItem width="50%" lg-width="100%">
					<Override
						...
						margin-right="-20%"
						padding-bottom="120%"
						background="url(https://images.unsplash.com/photo-1604752228829-cac7fffd93b6?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30&w=2000) 50% 15%/cover"
						lg-margin-right="0"
